...
@section('content')
            ...
            <form id="createNoteForm" action="{{ route('notes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea name="content" id="contentTextarea" style="display:none;">{{ old('content') }}</textarea>
                        ...
                        <div class="editor-wrapper">
                            <div class="editor-toolbar" id="editorToolbar">
                                ...
                                <div class="toolbar-group">
                                    ...
                                    <button type="button" class="toolbar-btn" data-action="taskList"
    ...
    <script type="module">
        ...
        const editor = new Editor({
            ...
            extensions: [
                ...
                Placeholder.configure({
                    placeholder: 'Start writing your note… Use / or the toolbar above.'
                }),
                Typography,
                CharacterCount,
            ],
            content: `{{ old('content') ? addslashes(old('content')) : '' }}`,
            onUpdate({
                editor
            }) {
        ...
        // Expose globally for file handling
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            ['dragenter', 'dragover'].forEach(e => uploadArea.addEventListener(e, () => uploadArea.classList.add(
                'drag-over')));
            ['dragleave', 'drop'].forEach(e => uploadArea.addEventListener(e, () => uploadArea.classList.remove(
                'drag-over')));
            uploadArea.addEventListener('drop', function(e) {
                ...
                const dt = new DataTransfer();
                [...Array.from(fileInput.files), ...dropped].forEach(f => dt.items.add(f));
                fileInput.files = dt.files;
                displayFiles(fileInput.files);
            });
        });
    ...
    {{-- Word count footer (injected after editor renders) --}}
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const wrapper = document.querySelector('.editor-wrapper');
            const footer = document.createElement('div');
            footer.className = 'editor-footer';
            footer.innerHTML = '<span id="wordCount">0 words · 0 chars</span>';
